...
/**
 * Primary content in *SkyDivee → Default → Primary*
 */
export interface SkyDiveeSliceDefaultPrimary {
  /**
   * Sentence field in *SkyDivee → Default → Primary*
   *
   * - **Field Type**: Text
   * - **Placeholder**: *None*
   * - **API ID Path**: sky_divee.default.primary.sentence
   * - **Documentation**: https://prismic.io/docs/field#key-text
   */
  sentence: prismic.KeyTextField;

  /**
   * Flavor field in *SkyDivee → Default → Primary*
   *
   * - **Field Type**: Select
   * - **Placeholder**: *None*
   * - **Default Value**: lemonLime
   * - **API ID Path**: sky_divee.default.primary.flavor
...
/**
 * Default variation for SkyDivee Slice
 *
 * - **API ID**: `default`
 * - **Description**: Default
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkyDiveeSliceDefault = prismic.SharedSliceVariation<
  "default",
  Simplify<SkyDiveeSliceDefaultPrimary>,
  never
>;

/**
 * Slice variation for *SkyDivee*
 */
type SkyDiveeSliceVariation = SkyDiveeSliceDefault;

/**
 * SkyDivee Shared Slice
 *
 * - **API ID**: `sky_divee`
 * - **Description**: SkyDivee
 * - **Documentation**: https://prismic.io/docs/slice
 */
export type SkyDiveeSlice = prismic.SharedSlice<
  "sky_divee",
  SkyDiveeSliceVariation
>;
...
declare module "@prismicio/client" {
  ...
  namespace Content {
    export type {
      ...
      HeroSliceDefault,
      SkyDiveeSlice,
      SkyDiveeSliceDefaultPrimary,
      SkyDiveeSliceVariation,
      SkyDiveeSliceDefault,
    };
  }
}
